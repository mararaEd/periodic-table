...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"loader.js":[function(require,module,exports) {
var intervalId = "";
...
var commonX = "0.35s ease-in forwards";
var commonY = "0.35s ease-out forwards";

exports.startAnimation = function (elmI) {
  var clipO = [3.28, 2.46, 1.64, 0.82, 0];
  var allLoaders = document.querySelectorAll(".loader__bar");
  var i = 2;
  var sec = false;
  var orderedA = [{
    x: "moveX ".concat(commonX),
    y: "moveY ".concat(commonY)
  }, {
...
},{}],"compare.js":[function(require,module,exports) {
"use strict";
...
var init = function init() {
  ...
  var formElmBtn = document.querySelector(".form__elements-button");
  var criteria = document.querySelector(".form__cri");
  var formCriteria = document.querySelector(".form__criteria");
  var elmContainer = document.getElementById("name");
  var propContainer = document.getElementById("prop");
  var btn = document.querySelector(".form__elements-button--b");

  var allElements = _toConsumableArray(elmContainer.childNodes);

  var data;
  [elmContainer, propContainer].forEach(function (el) {
    el.addEventListener("click", function (e) {
      var parent = e.target.closest(".form__elements-elm");
      if (parent) parent.classList.toggle("form__elements-elm--check");
    });
  });
  document.addEventListener("click", function (e) {
    if (e.target.matches(".form__input")) return formElement.classList.add("form__elements--show");
    if (e.target.matches(".form__cri")) return formCriteria.classList.toggle("form__elements--show");
  ...
  elmInput.addEventListener("keydown", function (e) {
    var value = elmInput.value;
    ...
    filteredElm.forEach(function (el) {
      return el.classList.add("form__elements-elm--h");
    });
  });

  var renderHtml = function renderHtml(obj) {
    var handleElms = function handleElms(a) {
      return a.map(function (el) {
        return "<div class=\"comp-row__result-elm\">".concat(el, "</div>");
      }).join("\n");
    };
    ...
    Object.values(obj).forEach(function (elm, i) {
      var myHtml = "\n      <div class=\"comp-row\">\n      <div class=\"comp-row__title\">".concat(keys[i], " :</div>\n      <div class=\"comp-row__result\">\n        ").concat(handleElms(elm), "\n      </div>\n    </div>\n      ");
      html = html.concat(myHtml);
    });
    document.querySelector(".comp-container").insertAdjacentHTML("beforeend", contHtml.replace("{HTM}", html));
  };
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var elementsO, comparingCriteriaO, elements, comparingCriteria, comR, result;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              e.preventDefault();
              elementsO = Array.from(elmContainer.children).filter(function (el) {
                return el.classList.contains("form__elements-elm--check");
              });
              comparingCriteriaO = Array.from(propContainer.children).filter(function (el) {
                return el.classList.contains("form__elements-elm--check");
              });
              elements = elementsO.map(function (el) {
                return +el.firstElementChild.dataset.atn;
              });
              comparingCriteria = comparingCriteriaO.map(function (el) {
                return el.firstElementChild.textContent.split(" ").join("");
              });
              elementsO.forEach(function (el) {
                el.classList.remove("form__elements-elm--check");
              });
              comparingCriteriaO.forEach(function (el) {
                el.classList.remove("form__elements-elm--check");
              }); // prepare Ui

              document.documentElement.style.setProperty("--bH", "auto");
              comR = document.querySelector(".com-row-container");
              comR && comR.remove();
              document.querySelector(".comp-container").insertAdjacentHTML("beforeend", "<div class=\"com-row-container\">\n            <div class=\"loader\">\n              <div class=\"loader__ball\"></div>\n              <div class=\"loader__bar loader__bar--1\"></div>\n              <div class=\"loader__bar loader__bar--2\"></div>\n              <div class=\"loader__bar loader__bar--3\"></div>\n              <div class=\"loader__bar loader__bar--4\"></div>\n              <div class=\"loader__bar loader__bar--5\"></div>\n            </div>              \n          </div>");

              _loader.default.startAnimation();
              ...
              return (0, _axios.default)({
                ...
                data: {
                  elements: elements,
                  comparingCriteria: comparingCriteria
                }
              });
  ...
  sBtn.addEventListener("click", function (e) {
    e.target.innerHTML = "&downarrow; ".concat(turn ? "A" : "DE", "SC");
    var arr = [];
    ...
    var ar = arr.flat();
    document.querySelectorAll(".comp-row__result-elm").forEach(function (el, i) {
      el.textContent = ar[i];
    });
    turn = !turn;
  });
...
},{"axios":"../../node_modules/axios/index.js","./loader":"loader.js"}],"../../node_modules/core-js/modules/es6.object.create.js":[function(require,module,exports) {
var $export = require('./_export');
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
...
},{"./_export":"../../node_modules/core-js/modules/_export.js","./_set-proto":"../../node_modules/core-js/modules/_set-proto.js"}],"../../node_modules/core-js/modules/es6.object.to-string.js":[function(require,module,exports) {
'use strict';
...
},{"./_classof":"../../node_modules/core-js/modules/_classof.js","./_wks":"../../node_modules/core-js/modules/_wks.js","./_redefine":"../../node_modules/core-js/modules/_redefine.js"}],"../../node_modules/core-js/modules/es6.function.bind.js":[function(require,module,exports) {
...
},{"./_export":"../../node_modules/core-js/modules/_export.js","./_is-array":"../../node_modules/core-js/modules/_is-array.js"}],"../../node_modules/core-js/modules/_strict-method.js":[function(require,module,exports) {
'use strict';
var fails = require('./_fails');
...
},{"./_export":"../../node_modules/core-js/modules/_export.js","./_string-at":"../../node_modules/core-js/modules/_string-at.js"}],"../../node_modules/core-js/modules/es7.string.trim-left.js":[function(require,module,exports) {
'use strict';
...
},{"./_object-keys":"../../node_modules/core-js/modules/_object-keys.js","./_to-iobject":"../../node_modules/core-js/modules/_to-iobject.js"}],"../../node_modules/core-js/modules/core.is-iterable.js":[function(require,module,exports) {
var classof = require('./_classof');
var ITERATOR = require('./_wks')('iterator');
var Iterators = require('./_iterators');
...
},{"./_classof":"../../node_modules/core-js/modules/_classof.js","./_wks":"../../node_modules/core-js/modules/_wks.js","./_iterators":"../../node_modules/core-js/modules/_iterators.js","./_core":"../../node_modules/core-js/modules/_core.js"}],"../../node_modules/core-js/modules/core.dict.js":[function(require,module,exports) {
'use strict';
var ctx = require('./_ctx');
var $export = require('./_export');
var createDesc = require('./_property-desc');
...
},{"./_global":"../../node_modules/core-js/modules/_global.js"}],"../../node_modules/core-js/modules/_partial.js":[function(require,module,exports) {
'use strict';
...
},{"./_export":"../../node_modules/core-js/modules/_export.js","./_classof":"../../node_modules/core-js/modules/_classof.js"}],"../../node_modules/core-js/modules/_object-define.js":[function(require,module,exports) {
var dP = require('./_object-dp');
var gOPD = require('./_object-gopd');
var ownKeys = require('./_own-keys');
var toIObject = require('./_to-iobject');
...
},{"./_export":"../../node_modules/core-js/modules/_export.js","./_object-define":"../../node_modules/core-js/modules/_object-define.js","./_object-create":"../../node_modules/core-js/modules/_object-create.js"}],"../../node_modules/core-js/modules/core.number.iterator.js":[function(require,module,exports) {
'use strict';
...
},{"./_export":"../../node_modules/core-js/modules/_export.js","./_replacer":"../../node_modules/core-js/modules/_replacer.js"}],"../../node_modules/core-js/index.js":[function(require,module,exports) {
require('./shim');
...
function () {
  ...
  _createClass(Unit, [{
    ...
    value: function calc(v, u) {
      ...
      var conditions = (_conditions = {}, _defineProperty(_conditions, this.perference.trim() === this.def.trim(), v), _defineProperty(_conditions, "o C", v - 273.15), _defineProperty(_conditions, "o F", (v - 273.15) * (9 / 5) + 32), _defineProperty(_conditions, "kg/m 3", v * 1000), _conditions);
...
var pref = (localStorage.getItem("unitsP") || "k, k, g/cm 3").split(",");
...
var _default = function _default() {
  ...
  var elmRow, landscape, curDef, curOption;
  ...
  document.addEventListener("click", function (e) {
    var toggler = e.target.closest(".nav__item-toggle-cont");

    if (toggler) {
      toggler.classList.toggle("nav__item-toggle-cont--toggled");
      return (0, _coreJs.setTimeout)(function () {
  ...
  popup.addEventListener("click", function (e) {
    if (!e.target.closest(".popup__content") || e.target.closest(".popup__close")) {
      ...
      var pE = document.querySelector(".popup__element");
      pE && pE.remove();
    }
    ...
    var accTitl = e.target.closest(".elem__overview-heading");

    if (e.target.classList.contains("h3") || e.target === accTitl || e.target.closest(".elem__overview-icon")) {
      var _getComputedStyle = getComputedStyle(accTitl.lastElementChild),
          height = _getComputedStyle.height;

      var trRel = _defineProperty({
        0: height
      }, height, 0);

      var next = document.querySelector(".elem__overview-heading[data-pos=\"".concat(+accTitl.dataset.pos + 1, "\"]"));
      if (!next && landscape) next = elmRow;

      if (next) {
        next.style.transitionDelay = getComputedStyle(next).transitionDelay.length === 2 ? "0.2s" : "0s";
        var curTy = next.dataset.tr;
  ...
  var cats = {
    ...
    atomicProperties: ["atomicNumber", "atomicRadius", "bondingType", "oxidationStates", "electronNegetavity", "electronAffinity", "vanDelWaalsRadius"],
    physicalProperties: ["boilingPoint", "meltingPoint", "appearance"],
    summary: ["summary"],
    ionizationEnergies: ["ionizationEnergies"]
  };

  var accordions = function accordions(det) {
    var ordinals = {
      0: "1<sup>st</sup>",
      1: "2<sup>nd</sup>",
      2: "3<sup>rd</sup>"
    ...
    return keys.map(function (k, i) {
      var nodes = [];
      cats[k].forEach(function (p) {
        var pref = units.slice(0, 2).find(function (u) {
          return u.stF.split(" ").join("") === p.toLocaleLowerCase();
        });
        if (Array.isArray(det[p])) return nodes.push(det[p].filter(function (_, i) {
          return i < 3;
        }).map(function (v, i) {
          return "\n          <div class=\"elem__overview-row\">\n          <h3 class=\"elem__title\">".concat(ordinals[i], " ionization energy</h3>\n          <p class=\"elem__detail\">").concat(v, "</p>\n        </div>\n          ");
        }).join("\n"));
        var title = p === "summary" ? "" : "<h3 class=\"elem__title\">".concat(handleName(p), "</h3>");
        nodes.push("\n        <div class=\"elem__overview-row\">\n        ".concat(title, "\n        <p class=\"elem__detail\">").concat(pref && det[p] ? pref.calc(det[p], pref.perference) + " " + handlePref(pref.perference) : det[p], "</p>\n      </div>        \n        "));
      });
      return "\n         <div data-tr=\"0\" data-pos=\"".concat(i + 1, "\" class=\"elem__overview-heading elem__overview-heading--sA elem__overview-heading--btn\">\n            <svg class=\"elem__overview-icon\">\n              <use xlink:href=\"/img/sprites.svg#icon-plus\"></use>\n            </svg>\n            <h3 class=\"h3\">").concat(handleName(k), "</h3>\n            <div class=\"elem__overview-accordion\">\n                ").concat(nodes.join("\n"), "\n            </div>\n        </div>\n         ");
    });
  };
  ...
  function () {
            ...
            case 0:
              ...
              try {
                ...
                regeneratorRuntime.mark(function _callee() {
                  var bone, myElm, _myElm$data$data$elem, elementProp, al, htm, html;
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _loader.default.startAnimation(); // Prepare
                        ...
                        case 7:
                          ...
                          return _context.abrupt("return", (0, _coreJs.setTimeout)(function () {
                        ...
                        case 17:
                          ...
                          (0, _coreJs.setTimeout)(function () {
                            ...
                            document.querySelector(".popup__element").innerHTML = html; // render element with appropriate height

                            var allHeadings = document.querySelectorAll(".elem__overview-heading");

                            var allH = _toConsumableArray(document.querySelectorAll(".elem__overview-accordion")).map(function (el) {
                            ...
                            document.querySelectorAll("h3").forEach(function (el) {
                              el.addEventListener("mouseenter", function (e) {
                                e.target.parentElement.style.animation = "border-dance 1s cubic-bezier(0.55, 0.055, 0.675, 0.19) infinite";
                              });
                              el.addEventListener("mouseleave", function (e) {
                                e.target.parentElement.style.animation = "border-danc 1s cubic-bezier(0.55, 0.055, 0.675, 0.19) infinite";
                              });
                            });
                          }, 5000);
    ...
    return function loadProperties(_x) {
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","core-js":"../../node_modules/core-js/index.js","./loader":"loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _periodic = _interopRequireDefault(require("./periodic"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

"use strict";

if (document.querySelector(".per-container")) (0, _periodic.default)();
if (document.querySelector(".compare-body")) (0, _compare.default)();
