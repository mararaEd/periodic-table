...
var init = function init() {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var elementsO, comparingCriteriaO, elements, comparingCriteria, result;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              document.querySelector(".comp-container").insertAdjacentHTML("beforeend", "<div class=\"com-row-container\"></div>");

              _loader.default.startAnimation(document.querySelector(".com-row-container"));
            ...
            case 15:
              ...
              _loader.default.stopAnimation(document.querySelector(".com-row-container"));
  ...
  sBtn.addEventListener("click", function (e) {
    ...
    turn = !turn; // data.elements.reverse();
    // document
...
module.exports = init;
},{"axios":"../../node_modules/axios/index.js","./loader":"loader.js"}],"periodic.js":[function(require,module,exports) {
"use strict";
...
module.exports = function () {
  ...
  container.addEventListener("click", function (e) {
    var atN = +e.target.closest(".elm")?.firstElementChild.textContent;
    if (!atN) return "error";
    loadProperties({
      field: "atomicNumber",
      query: atN
